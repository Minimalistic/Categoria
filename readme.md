...
This is a catalog website that stores and displays restaurants, menus and menu items. It also permits adding and deleting entries. It was created for a Udacity project and is hosted on an AWS instance, the live website can be found at [www.restaurantstuff.info](http://www.restaurantstuff.info)
